 ...
 * `compose/brand.ts`.
 */
export declare function brandFontFor(role: 'heading' | 'body', kit: Pick<TBrandKit, 'fonts'>): TFontItem | undefined;
/**
 ...
 */
export declare function surfaceColors(layers: TdWidgetData[], page: TPageState): (index: number) => string | null;
