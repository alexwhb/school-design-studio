 ...
 */
import { PAINT_FIELDS, PAINT_NUMBER_FIELDS, SAFE_FONT_FAMILY, SANITISED_FIELDS, TEXT_FIELDS } from '../components/modules/widgets/widgetTypes';
 ...
 */
export declare function sanitizeFieldsInPlace(next: DesignDocument): FieldReport;
