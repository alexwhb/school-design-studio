...
import type { DesignIssue } from '../methods/accessibility/checkDesign';
 ...
 */
export declare const AssistantContext: import("react").Context<ReactNode>;
export declare function useAssistant(): ReactNode | null;
