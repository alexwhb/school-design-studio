...
import { type PptxAlt } from './pptxAlt';
 ...
 */
export declare function applyPptxMotion(blob: Blob, motion: SlideMotion[], alts?: ReadonlyArray<ReadonlyMap<string, PptxAlt>>): Promise<Blob>;
