 ...
 */
import type { HostImportMeta, HostUploads } from '../hooks/hostApi';
...
export declare function hostImportsUrls(): boolean;
/**
 ...
 */
export declare function importRemoteImage(url: string, meta: HostImportMeta): Promise<LocalUpload>;
 ...
 */
export declare function explainUploadError(error: unknown, fallback: string): string;
