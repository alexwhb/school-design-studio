...
export default function DesignStudio({ mode, apiUrl, homeUrl, appName, config, theme, brand, onBrandChange, brandReadOnly, brandReadOnlyNote, document: hostDocument, documentKind, onDocumentChange, onSave, saveLabel, uploads, assistant, ref, className, style }: DesignStudioProps): import("react").JSX.Element;
