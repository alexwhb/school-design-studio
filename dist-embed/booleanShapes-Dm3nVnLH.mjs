import { g as Te, c as Me, a as Oe, S as fe, p as ze, r as Ae, b as Le, d as ke, e as Ne, w as Ee, f as Be, i as Fe, h as De, v as Re } from "./DesignViewer-D3ruj6W3.mjs";
import { _ as Ve } from "./__vite-browser-external-YbutIfMq.mjs";
import { a as qe, w as He } from "./index-BAzME_vH.mjs";
var de = { exports: {} };
const ce = /* @__PURE__ */ Te(Ve);
/*!
...
(function(q) {
  (function(H, B) {
    H = H || ce;
    var j = H.window, tt = H.document, I = new function() {
    ...
    var gt = {
      ...
      setup: function(t) {
        return rt = this, this.project = new jt(t), this;
      },
    ...
    var et = new function() {
      ...
      equals: function(t) {
        var e = I.isPlainValue(t) ? Y.read(arguments) : t;
      ...
      contains: function(t) {
        return t && t.width !== B || (Array.isArray(t) ? t : arguments).length === 4 ? this._containsRectangle(Y.read(arguments)) : this._containsPoint(L.read(arguments));
      },
      ...
      intersects: function() {
        var t = Y.read(arguments), e = I.read(arguments) || 0;
        return t.x + t.width > this.x - e && t.y + t.height > this.y - e && t.x < this.x + this.width + e && t.y < this.y + this.height + e;
      },
      intersect: function() {
        var t = Y.read(arguments), e = Math.max(this.x, t.x), i = Math.max(this.y, t.y), n = Math.min(this.x + this.width, t.x + t.width), r = Math.min(this.y + this.height, t.y + t.height);
        return new Y(e, i, n - e, r - i);
      },
      unite: function() {
        var t = Y.read(arguments), e = Math.min(this.x, t.x), i = Math.min(this.y, t.y), n = Math.max(this.x + this.width, t.x + t.width), r = Math.max(this.y + this.height, t.y + t.height);
        return new Y(e, i, n - e, r - i);
      },
      include: function() {
      ...
      I.each(
        ...
        },
        {
          ...
          setBounds: function() {
            var t = Y.read(arguments), e = this.getBounds(), i = this._matrix, n = new ft(), r = t.getCenter();
          ...
          _getBounds: function(t, e) {
            ...
            return !i || !i.length ? new Y() : ($._updateBoundsCache(this, e.cacheItem), $._getBounds(i, t, e));
          },
          ...
          statics: {
            ...
            _getBounds: function(t, e, i) {
              ...
              return {
                rect: isFinite(n) ? new Y(n, s, r - n, o - s) : new Y(),
                nonscaling: a
              };
            }
          }
      ...
      }(),
      {
        ...
        statics: {
          _getItems: function t(e, i, n, r, s) {
            if (!r) {
              var o = typeof i == "object" && i, a = o && o.overlapping, h = o && o.inside, u = a || h, c = u && Y.read([u]);
              r = {
                items: [],
      ...
      I.each(["rotate", "scale", "shear", "skew"], function(t) {
        ...
        fitBounds: function(t, e) {
          t = Y.read(arguments);
          var i = this.getBounds(), n = i.height / i.width, r = t.height / t.width, s = (e ? n > r : n < r) ? t.width / i.width : t.height / i.height, o = new Y(
            new L(),
    ...
    }), zt = $.extend(
      {
        ...
        _getBounds: function(t, e) {
          var i = new Y(this._size).setCenter(0, 0), n = this._style, r = e.stroke && n.hasStroke() && n.getStrokeWidth();
        ...
        function t(i, n, r) {
          ...
          if (!s.isZero())
            for (var o = i._size.divide(2), a = 1; a <= 4; a++) {
              var h = new L(a > 1 && a < 4 ? -1 : 1, a > 2 ? -1 : 1), u = h.multiply(o), _ = u.subtract(h.multiply(s)), d = new Y(
            ...
            if (u || _) {
              ...
              if (d === "rectangle") {
                ...
                if (C)
                  ...
                  var p = new Y(this._size).setCenter(0, 0), m = p.expand(y), f = p.expand(y.negate());
      ...
      }(),
      {
        statics: new function() {
          ...
          return {
            ...
            Rectangle: function() {
              var e = arguments, i = Y.readNamed(e, "rectangle"), n = G.min(
      ...
      getSubCanvas: function() {
        var t = Y.read(arguments), e = wt.getContext(t.getSize());
        return e.drawImage(
          this.getCanvas(),
          t.x,
          t.y,
      ...
      getSubRaster: function() {
        var t = Y.read(arguments), e = new Xt($.NO_INSERT);
      ...
      getAverageColor: function(t) {
        var e, i;
        if (t ? t instanceof Ut ? (i = t, e = t.getBounds()) : typeof t == "object" && ("width" in t ? e = new Y(t) : "x" in t && (e = new Y(t.x - 0.5, t.y - 0.5, 1, 1))) : e = this.getBounds(), !e)
          return null;
      ...
      getImageData: function() {
        ...
        return t.isEmpty() && (t = new Y(this._size)), this.getContext().getImageData(
          t.x,
          t.y,
          t.width,
          t.height
      ...
      _getBounds: function(t, e) {
        var i = new Y(this._size).setCenter(0, 0);
      ...
      },
      {
        ...
        statics: {
          ...
          getBounds: function(t) {
            ...
            return new Y(e[0], e[1], i[0] - e[0], i[1] - e[1]);
          },
        ...
        statics: {
          getBounds: function(t, e, i, n, r, s) {
            ...
            for (var l = 1, v = t.length; l < v; l++)
              c(t[l]);
            return e && c(o), new Y(u[0], u[1], _[0] - u[0], _[1] - u[1]);
          },
          getStrokeBounds: function(t, e, i, n, r) {
            ...
            if (!o)
              return _;
            var d = a / 2, c = s.getStrokeJoin(), l = s.getStrokeCap(), v = s.getMiterLimit(), y = new Y(new G(u));
            function C(S) {
              _ = _.include(S);
            }
            function p(S) {
    ...
    ot.inject({ statics: new function() {
      ...
      return {
        ...
        Rectangle: function() {
          var r = arguments, s = Y.readNamed(r, "rectangle"), o = G.readNamed(
            r,
            "radius",
            0,
            { readNull: !0 }
    ...
    var he = I.extend(
      ...
      return {
        ...
        getBounds: function(e, i) {
          ...
          return new Y(a, h, o.width, o.height);
        },
    ...
    Ct.requestAnimationFrame = new function() {
      var t = vt.getPrefixed(j, "requestAnimationFrame"), e = !1, i = [], n;
      function r() {
        var s = i;
        i = [];
    ...
    var pt = I.extend(
      gt,
      {
        ...
        initialize: function t(e, i) {
          ...
          if (j && i) {
            ...
            s = new G(i), i = null;
          this._project = e, this._scope = e._scope, this._element = i, this._pixelRatio || (this._pixelRatio = j && j.devicePixelRatio || 1), this._setElementSize(s.width, s.height), this._viewSize = s, t._views.push(this), t._viewsById[this._id] = this, (this._matrix = new ft())._owner = this, t._focused || (t._focused = this), this._frameItems = {}, this._frameItemCount = 0, this._itemEvents = { native: {}, virtual: {} }, this._autoUpdate = !rt.agent.node, this._needsUpdate = !1;
        },
        remove: function() {
          if (!this._project)
            return !1;
          ...
          var t = this._project;
          return t._view === this && (t._view = null), Ct.remove(this._element, this._viewEvents), Ct.remove(j, this._windowEvents), this._element = this._project = null, this.off("frame"), this._animate = !1, this._frameItems = {}, !0;
        },
        _events: I.each(
      ...
      new function() {
        ...
        var a = j.navigator, h, u, _;
        a.pointerEnabled || a.msPointerEnabled ? (h = "pointerdown MSPointerDown", u = "pointermove MSPointerMove", _ = "pointerup pointercancel MSPointerUp MSPointerCancel") : (h = "touchstart", u = "touchmove", _ = "touchend touchcancel", "ontouchstart" in j && a.userAgent.match(
      ...
      _class: "CanvasView",
      initialize: function(e, i) {
        if (!(i instanceof j.HTMLCanvasElement)) {
        ...
        if (r.save(), this._pixelRatio = 1, !/^off|false$/.test(lt.getAttribute(i, "hidpi"))) {
          var s = j.devicePixelRatio || 1, o = vt.getPrefixed(
            r,
    ...
    new function() {
      ...
      $.inject({
        ...
        exportSVG: function(m) {
          m = p(m);
          var f = this._children, g = this.getView(), w = I.pick(m.bounds, "view"), S = m.matrix || w === "view" && g._matrix, x = S && ft.read([S]), b = w === "view" ? new Y([0, 0], g.getViewSize()) : w === "content" ? $._getBounds(f, x, { stroke: !0 }).rect : Y.read([w], 0, { readNull: !0 }), P = {
            version: "1.1",
            xmlns: mt.svg,
      ...
      var l = I.set(I.each(le, function(f) {
        ...
        viewBox: function(f, g, w, S, x) {
          var b = new Y(s(g, "array")), P = r(S, null, null, !0), T, z;
          if (f instanceof Bt) {
      ...
      function C(f) {
        var g = f && f.match(/\((?:["'#]*)([^"')]+)/), w = g && g[1], S = w && t[j ? w.replace(j.location.href.split("#")[0] + "#", "") : w];
...
function ie(q, H, B) {
  const j = q.lastSegment.point, tt = j.getDistance(B);
  if (tt <= 0) {
    q.lineTo(H);
    return;
  }
  const I = j.subtract(B).normalize().add(H.subtract(B).normalize());
...
function Ue(q, H, B) {
  ...
  return _t.moveTo(lt(j, 0)), _t.lineTo(lt(q - tt, 0)), ie(_t, lt(q, tt), lt(q - tt, tt)), _t.lineTo(lt(q, H - I)), ie(_t, lt(q - I, H), lt(q - I, H - I)), _t.lineTo(lt(gt, H)), ie(_t, lt(0, H - gt), lt(gt, H - gt)), _t.lineTo(lt(0, j)), ie(_t, lt(j, 0), lt(j, j)), _t.closePath(), _t;
}
function ge(q) {
...
function We(q, H, B) {
  var I;
  const j = ke(H, B, ((I = Ee(q)) == null ? void 0 : I.width) || 0, Ne(q)), tt = Be(De(q), Fe(q), j);
...
function Je(q, H, B) {
  const j = String(q.svgUrl || "");
  if (!j.trim().startsWith("<"))
    return null;
  const I = new DOMParser().parseFromString(j, "image/svg+xml").documentElement;
...
function Xe(q, H, B) {
  switch (String(q.type)) {
    ...
    case "w-polygon":
      return dt.PathItem.create(ze(H, B, Ae(q)));
    case "w-path":
      return We(q, H, B);
    case "w-svg":
      return Je(q, H, B);
...
function Ye(q) {
  ...
  if (!j)
    return null;
  const tt = Ke(q);
  return tt && j.rotate(tt, new dt.Point(H / 2, B / 2)), j.translate(new dt.Point(Number(q.left) || 0, Number(q.top) || 0)), j;
}
function je(q) {
  var H;
...
function Qe(q) {
  return q.replace(/-?\d+\.\d+/g, (H) => String(Yt(Number(H))));
}
function $e(q, H, B) {
...
function ni(q, H) {
  ...
  try {
    ...
    if (!tt || tt.isEmpty())
      return null;
    const I = tt.bounds, gt = Yt(I.width), lt = Yt(I.height);
    if (gt < 1 || lt < 1)
      return null;
    ...
    if (!_t)
      return null;
    const yt = H[0], ht = JSON.parse(JSON.stringify(He));
    return ht.left = Yt(I.x), ht.top = Yt(I.y), ht.width = gt, ht.height = lt, ht.svgUrl = $e(_t, gt, lt), ht.colors = [je(yt)], ht.opacity = Number(yt.opacity ?? 1), ht.borderWidth = Number(yt.borderWidth) || 0, ht.borderColor = yt.borderColor || "#000000ff", ht.borderStyle = yt.borderStyle || "solid", yt.shadow && (ht.shadow = JSON.parse(JSON.stringify(yt.shadow))), ht;
  } finally {
    B.clear();
  }
}
